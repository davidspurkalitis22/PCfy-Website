...
// URLs for TEST mode (ATU hosting)
...
// define('PAYMENT_SUCCESS_URL', 'https://www.pcfy.ie/PCFYwebsite/payment-success.php');
// define('PAYMENT_CANCEL_URL', 'https://www.pcfy.ie/PCFYwebsite/payment-cancel.php'); 